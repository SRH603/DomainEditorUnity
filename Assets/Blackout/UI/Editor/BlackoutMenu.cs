...
{
    public static class BlackoutMenu 
    {
        ...
        public static BlackoutBuilder.Resources _standardResources;

        public static BlackoutBuilder.Resources GetStandardResources()
        {
        ...
        {
            // Root for the UI
            GameObject root = ObjectFactory.CreateGameObject("Canvas", typeof(Canvas), typeof(CanvasScaler), typeof(GraphicRaycaster));
        ...
        private static void CreateEventSystem(bool select, GameObject parent)
        {
            ...
            EventSystem esys = stage.FindComponentOfType<EventSystem>();
            if (esys == null)
            {
