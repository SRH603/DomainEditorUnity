...
namespace Battlehub.RTCommon
{
    ...
    public class DragDropTarget : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IDragDropTarget
    {
        ...
        void IPointerExitHandler.OnPointerExit(PointerEventData eventData)
        {
            ...
            else if (m_pointerOverCount < 0) 
            {
                // Handles the case where OnPointerExit is called without first calling OnPointerEnter
                // for example, using the ExecuteEvents.ExecuteHierarchy method;
                m_pointerOverCount = 0;
            }
        }
